...
def exp_gid_search(exp_str='exp1', seed=0, lambdas=np.logspace(-6, 3, num=10), alphas=(0.01, 0.1, 1, 10, 100, 1000),
...
if __name__ == '__main__':
    #exp_gid_search('exp2', y_snr=10, task_std=2, n_train=50, n_tasks=100,
